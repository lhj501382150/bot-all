...
public class BackCoreConfig {
	...
	public static String CLEAR_MONEY = "/apis/Account/ClearAll";
	public static String ALTER_BOT_INTEGE = "/apis/Data/MdiBodIntege";
	public static String ALTER_PARA = "/apis/Data/MdiSysPara";
